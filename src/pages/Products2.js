...
const [target2, setTarget2] = useState([])
  ...
  const pages2 = {
    Books: [
      ...
      "https://ostan-mr.ir/uploads/books/saramad/saramad-29.png",
        ...
        __v: 0,
        url: "https://ostan-mr.ir/uploads/books/saramad/saramad-1.png",
        id: "66c3055ef1466acf04731b76",
      },
    ],
  };
  const showReverse2 = pages2.Books[0].slides.reverse();
  // const val = showReverse.unshift('')

  const totalPages = pages2.Books[0].slides.length;
  ...
  useEffect(() => {
    const preloadImages = async () => {
      const promises = showReverse2.map((src) => {
      ...
      setImagesLoaded2(true); // Set this to true once all images are loaded
    };
...
return (
  <div
    ...
    <HTMLFlipBook
      ...
      {pages2.Books[0].slides.map((item, index) => (
